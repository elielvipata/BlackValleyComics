...
Rename the `Auth0.plist.example` file to `Auth0.plist`, and replace the placeholder `ej139xd7vQJThudMEq7iUqbEz9KumsdC` and `dev-qncgc455afc8kedu.us.auth0.com` values with the Client ID and Domain of your Auth0 application. If you are using a [custom domain](https://auth0.com/docs/customize/custom-domains), use the value of your custom domain instead of the value from the settings page.
...
<dict>
    <key>ClientId</key>
    <string>ej139xd7vQJThudMEq7iUqbEz9KumsdC</string>
    <key>Domain</key>
    <string>dev-qncgc455afc8kedu.us.auth0.com</string>
</dict>
</plist>
```
